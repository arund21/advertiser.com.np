                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="text" class="form-control" name="version" value="{{ $product->version}}" placeholder="@lang('Enter version')" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" placeholder="@lang('Enter project demo link')" name="demo_link" value="{{ $product->demo_link}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form-control" name="rating" value="{{ $product->rating}}" placeholder="@lang('Enter rating')" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form-control" name="response" value="{{ $product->response}}" placeholder="@lang('Enter response')" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="card border--primary">
                                                            ...
                                                            <div class="card-body addedField">
                                                                @if ($product->links)
                                                                    @foreach ($product->links as $key => $item)
                                                                        <div class="row user-data">
                                                                            @if ($key == 0)
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <div class="input-group mb-md-0">
                                                                                            <input type="url" name="links[]" class="form-control" type="text" placeholder="@lang('Enter valid url')" value="{{$item}}">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            @endif
...
@push('script')
    ...
    <script>
        ...
        (function ($) {
            ...
            $('select[name="upload_system"]').val('{{$product->type}}');
