    ...
    <div class="container">
      <div class="main-ad-section">
        ...
        <div class="main-section">
            <form class="search-form mb-4" action="{{route('product.search')}}" method="GET">
                <input type="text" name="search" autocomplete="off" placeholder="@lang('Search here')..." class="form--control" required>
                <button type="submit" class="search-btn"><i class="las la-search"></i> @lang('Search')</button>
            </form>
            ...
            <section class="pb-50 pt-50">
                <div class="section-header">
                  <h2 class="section-title">@lang('You May Also Like These')</h2>
                </div>
